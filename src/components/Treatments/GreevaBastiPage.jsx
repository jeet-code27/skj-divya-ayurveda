...
export default function GreevaBastiPage() {
  const benefits = [
    "गर्दन की नसों और मांसपेशियों में राहत",
    "गर्दन की सूजन और अकड़न में राहत",
    "मस्तिष्क व मेरुरज्जु (स्पाइनल कॉर्ड) के रक्त संचार में सुधार",
    "वात दोष को शांत करता है",
    "सर्वाइकल पेन और सरदर्द में राहत",
  ];

  const indications = [
    { name: "सर्वाइकल स्पॉन्डिलोसिस", icon: Shield },
    { name: "गर्दन में अकड़न", icon: Droplets },
    { name: "गर्दन का दर्द", icon: Shield },
    { name: "सिरदर्द", icon: Shield },
    { name: "स्पाइनल कॉर्ड संबंधित समस्या", icon: Shield },
  ];
  ...
  const processSteps = [
    {
      step: "01",
      title: "तैयारी",
      desc: "गेहूं/मूंग दाल के आटे से गर्दन के चारों ओर बांध जैसा घेरा बनाते हैं।",
    },
    {
      step: "02",
    ...
    },
    {
      step: "04",
      title: "परिणाम",
      desc: "गर्दन के दर्द, अकड़न और स्पॉन्डिलोसिस में उल्लेखनीय लाभ मिलता है।",
    },
  ];
    ...
    <>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <h2 className="text-xl md:text-2xl text-emerald-700 mb-6 font-medium">
              गर्दन दर्द और सर्वाइकल के लिए विशेष उपचार
            </h2>

            <p className="text-gray-600 text-lg leading-relaxed mb-8">
              ग्रीवा बस्ति एक आयुर्वेदिक उपचार है जिसमें औषधीय तेल को गर्दन के
              पीछे एक विशेष बांध में रखा जाता है। यह नसों और मांसपेशियों को आराम
              देता है और स्पॉन्डिलोसिस व गर्दन की समस्याओं में अत्यंत लाभकारी
              है।
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link
                href="/appointment"
                className="inline-flex items-center justify-center bg-gradient-to-r from-emerald-500 to-teal-600 text-white px-8 py-3 rounded-full font-medium shadow-lg"
              >
              ...
              <Link
                ...
                className="inline-flex items-center justify-center border-2 border-emerald-500 text-emerald-600 px-8 py-3 rounded-full font-medium"
              >
          ...
          <div className="relative">
            <div className="rounded-3xl overflow-hidden shadow-2xl">
              <Image
                src="/images/greeva-basti.webp"
                alt="ग्रीवा बस्ति उपचार"
                width={600}
                height={400}
      ...
      <section className="py-16 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h2 className="text-3xl md:text-4xl text-gray-800 mb-10">
            ग्रीवा बस्ति के लाभ
          </h2>
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            {benefits.map((benefit, index) => (
              <div
                key={index}
                className="bg-gradient-to-r from-emerald-50 to-teal-50 p-6 rounded-2xl border border-emerald-100 hover:shadow-lg transition"
              >
      ...
      <section className="py-16 bg-gradient-to-r from-emerald-500 to-teal-600">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl md:text-4xl text-white mb-6">
            ग्रीवा बस्ति के लिए अपॉइंटमेंट बुक करें
          </h2>
